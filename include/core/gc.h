...
#define gc_malloc(_, size) malloc(size)
#define gc_calloc(_, count, size) calloc(count, size)
#define gc_realloc(_, ptr, size) realloc(ptr, size)
#define gc_free(_, ptr) free(ptr)

#define gc_strdup(_, s) strdup(s)
...
static GarbageCollector gc;  // Global garbage collector for all
...
// static inline size_t gc_run(GarbageCollector* gc);
...
// static inline void* gc_malloc_ext(GarbageCollector* gc, size_t size, void(*dtor)(void*))
// {
//     return gc_allocate(gc, 0, size, dtor);
// }

// static inline void* gc_malloc_static(GarbageCollector* gc, size_t size, void(*dtor)(void*))
// {
...
// static inline void* gc_make_static(GarbageCollector* gc, void* ptr)
// {
//     gc_make_root(gc, ptr);
//     return ptr;
// }

// static inline void* gc_malloc(GarbageCollector* gc, size_t size)
// {
//     return gc_malloc_ext(gc, size, NULL);
// }

// static void* gc_calloc_ext(GarbageCollector* gc, size_t count, size_t size,
//                     void(*dtor)(void*))
// {
...
// static void* gc_calloc(GarbageCollector* gc, size_t count, size_t size)
// {
//     return gc_calloc_ext(gc, count, size, NULL);
// }

// static void* gc_realloc(GarbageCollector* gc, void* p, size_t size)
// {
...
// static void gc_free(GarbageCollector* gc, void* ptr)
// {
//     Allocation* alloc = gc_allocation_map_get(gc->allocs, ptr);
//     if (alloc) {
//         if (alloc->dtor) {
...
// static void gc_start_ext(GarbageCollector* gc,
//                   void* bos,
...
// static void gc_resume(GarbageCollector* gc)
// {
//     gc->paused = false;
// }

// static void gc_mark_alloc(GarbageCollector* gc, void* ptr)
// {
//     Allocation* alloc = gc_allocation_map_get(gc->allocs, ptr);
...
// static void gc_mark_stack(GarbageCollector* gc)
// {
...
// static size_t gc_sweep(GarbageCollector* gc)
// {
...
//  */
// static void gc_unroot_roots(GarbageCollector* gc)
// {
...
// static size_t gc_stop(GarbageCollector* gc)
// {
//     gc_unroot_roots(gc);
...
// static char* gc_strdup (GarbageCollector* gc, const char* s)
// {
